...
declare type GiscusRepo = `${string}/${string}`;
declare type GiscusMapping = "url" | "title" | "og:title" | "specific" | "number" | "pathname";
declare type GiscusInputPosition = "top" | "bottom";
...
export { CommentOptions, CommentPluginFrontmatter, GiscusInputPosition, GiscusMapping, GiscusOptions, GiscusRepo, TwikooInitOptions, TwikooOptions, WalineLocaleConfig, WalineLocaleData, WalineOptions, commentPlugin, commentPlugin as default, walineLocales };
