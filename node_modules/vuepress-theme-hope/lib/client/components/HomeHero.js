        ...
        return () => h("header", { class: "hero" }, [
            ...
            slots["heroInfo"]?.() ||
                h("div", { class: "hero-info" }, [
                    heroText.value
                        ? h(DropTransition, { appear: true, delay: 0.04 }, () => h("h1", { id: "main-title" }, heroText.value))
                        : null,
                    tagline.value
                        ? h(DropTransition, { appear: true, delay: 0.08 }, () => h("p", { class: "description" }, tagline.value))
                        : null,
                    actions.value.length
                        ? h(DropTransition, { appear: true, delay: 0.12 }, () => h("p", { class: "actions" }, actions.value.map((action) => h(AutoLink, {
